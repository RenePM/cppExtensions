...
// 
// DLL EXPORT/IMPORT Interface Defines
#ifdef CPPDEBUG_EXPORTS
#   define CPPDEBUG_API    __declspec(dllexport)
#   define CPPDEBUG_FUNC   extern "C" __declspec(dllexport)
#define CPPDEBUG_TEMPLATE
#else
#   define CPPDEBUG_API    __declspec(dllimport)
#   define CPPDEBUG_FUNC   extern "C" __declspec(dllimport)
#   define CPPDEBUG_TEMPLATE   extern 
#endif
...
//**EXPIMP_TEMPLATE template class CPPDEBUG_API std::basic_ostringstream<char>;
//**EXPIMP_TEMPLATE template class CPPDEBUG_API std::basic_string<char>;

namespace rpmExt
{

	class CPPDEBUG_API cppDebug
	{

	public:
        // Data struct that keep track of last know debug location
        struct CPPDEBUG_API structDebugInfo
        {
            string appName_;
            string fileName_;
            string className_;
            ...
            */
            ...
            /*
            bool operator< (const structDebugInfo obj_) const
            {
                return (lineNum_ < obj_.lineNum_);
            }
    ...
    // File mode ids
        ...
        */
        ...
        /*
            ...
            RETURN:
        */
        cppDebug(string logFileName_ = "", enumFileModes openMode_ = enumFileModes::IS_APPEND_FROM_END);
