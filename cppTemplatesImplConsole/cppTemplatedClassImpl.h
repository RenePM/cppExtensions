...
#ifndef CPPTEMPLATEDCLASSIMPL_H // INCLUDE GUARD, Ensure the Header is not redefined more then once (DONT FORGET TO CHANE NAME TO [fileName]_H
#define CPPTEMPLATEDCLASSIMPL_H
...
{
    /*
        C++ Templated Class Template implemnted in one header (.h) file, hence
        DESIGN/DEFINITION and IMPLEMENTATION/DECLARATION is in same file

        Class used for ?
        DESIGN NOTE: Uses PIMPL to avoid exposing C++ STL to user/client
